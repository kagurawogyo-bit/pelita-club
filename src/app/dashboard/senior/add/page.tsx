...
export default function AddSeniorPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    data.role = "SENIOR";
    if (!data.password) data.password = "senior123";
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(result.error || "Gagal menambahkan senior");
      }

      setSuccess(true);
      setTimeout(() => router.push("/dashboard/senior"), 2000);
    ...
    return (
      <div className="animate-fade-in" style={{ padding: '40px', textAlign: 'center' }}>
        <div className="glass-panel" style={{ borderColor: 'var(--accent-secondary)' }}>
          <h2 style={{ color: 'var(--accent-secondary)', marginBottom: '16px', fontSize: '1.8rem' }}>Senior Berhasil Ditambahkan!</h2>
  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
        ...
        <h2 style={{ fontSize: '1.8rem', fontWeight: 700 }}>Tambah Senior Baru</h2>
      </div>

      <div className="glass-panel">
        <p style={{ color: 'var(--text-secondary)', marginBottom: '32px' }}>
          Input data senior baru ke dalam sistem. Password default akan diatur sebagai <strong>senior123</strong>.
        </p>
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid-cols-2">
            <div className="input-group">
              <label className="input-label">Email Senior</label>
            ...
            <div className="input-group">
              ...
              <input type="text" name="password" className="input-field" placeholder="Biarkan kosong untuk senior123" minLength={6} />
            </div>
          </div>
          ...
          <div style={{ marginTop: '32px', display: 'flex', gap: '16px', justifyContent: 'flex-end' }}>
            ...
            <button type="submit" disabled={loading} className="btn btn-primary" style={{ padding: '12px 24px', minWidth: '150px' }}>
              {loading ? "Menyimpan..." : "Simpan Senior"}
            </button>
          </div>
        </form>
      </div>
